    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "assignments",
                    models.ManyToManyField(blank=True, to="api.assignment"),
                ),
                (
                    "clients",
                    models.ManyToManyField(
                        blank=True, related_name="clients", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "assignments",
                    models.ManyToManyField(blank=True, to="api.assignmentclient"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "choice_replies",
                    models.ManyToManyField(blank=True, to="api.blockchoice"),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="assignment_client", to="api.block"
            ),
        ),
        migrations.AddField(
            model_name="assignmentclient",
        ...
        migrations.AddField(
            ...
            name="blocks",
            field=models.ManyToManyField(
                blank=True, related_name="assignment", to="api.block"
            ),
        ),
        migrations.AddField(
            model_name="assignment",
