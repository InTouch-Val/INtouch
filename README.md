...
2. Создать локально дочернюю ветку от develop для разрабатываемой фичи (при этом необходимо находиться непосредственно в ветке develop), желательно с именованием feature/название_вашей_фичи, fix/branch_name (если нужно исправить ошибки или логику функционала) или chore/branch_name (если нужно решить задачу, не повлияющую на производственный код)
