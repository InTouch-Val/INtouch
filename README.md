...
- `git merge --no-ff master` - вносите в свою ветку изменения, которые появились в девелопе (ваш код останется)
