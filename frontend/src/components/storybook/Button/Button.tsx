...
const Button: React.FC<ButtonProps> = ({ primary, label, backgroundColor, size, disabled }) => {
  const baseStyle = "border rounded font-medium focus:outline-none";
  const primaryStyle = "text-white bg-blue-500 hover:bg-blue-700";
  const secondaryStyle = "text-gray-800 bg-transparent border-gray-400 hover:bg-gray-200";
