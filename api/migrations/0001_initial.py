    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='default_user_photo.jpg', upload_to='user_photos')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='block',
            name='choice_replies',
            field=models.ManyToManyField(blank=True, related_name='block_choices', to='api.blockchoice'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='blocks',
            field=models.ManyToManyField(blank=True, related_name='blocks', to='api.block'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='comments',
        ...
        migrations.AddField(
            model_name='user',
            name='clients',
            field=models.ManyToManyField(blank=True, through='api.ClientRelationship', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
